...
//            + "\tThen type either 'node' or 'edge' to specify if you want to access a node or an
// edge.\n"
//            + "\tThen specify the name of the node/edge that you want to access.");
//    System.out.println(
//        "To update information in a node, please type 'update'\n"
//            + "\tThen type either 'location' or 'name' to specify if you are updating either the
// node's coordinates or it's name, Then submit the node's ID\n "
...
//            + "\tIf you want to overwrite the current database with new data, submit first the
// path to the CSV with the nodes and then the CSV with the edges");
//    System.out.println(
//        "To export to CSV, please type 'export'\n"
//            + "\tThen specify the output path for the CSV for the nodes and then the output path
// for the CSV for the edges");
//    System.out.println(
//        "To run an BFS search between nodes, please type 'BFS' and then submit the names of the
// start and end nodes");
//    System.out.println(
//        "To run an A* search between nodes, please type 'Astar' and then submit the names of the
// start and end nodes");
