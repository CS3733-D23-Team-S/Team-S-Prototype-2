...
public class Food {
    ...
    public Food(int ID, int name, String type, int prepTime, String cuisine, float price, String description,
                int quantity, boolean isSoldOut, FoodFilter filter, BufferedImage image) {
        this.ID = ID;
        this.name = name;
        this.type = type;
